...
description: Guide explicit Git and versioning work such as commits, branches, worktrees, release tags, semantic versions, and changelogs. Use when the user asks for one of those operations or for Git workflow design. Do not invoke for ordinary code edits that do not require a Git action.
---
